...
% Tipos de citação ----------------------------------------
    ...
    \begin{itemize}
        ...
        \item Ou \textit{apud}, onde o primeiro autor é citado pelo segundo -- \apud{yoo2010research}{wortmann2015internet}
    \end{itemize}

    Apenas os dois primeiros funcionam no formato de citações numéricas.
